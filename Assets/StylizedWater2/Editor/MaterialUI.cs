...
namespace StylizedWater2
{
    public class MaterialUI : ShaderGUI
    {
        ...
        private AnimBool helpAnimation;
        ...
        private void OnEnable()
        {
            ...
            helpAnimation = new AnimBool(false);
            helpAnimation.valueChanged.AddListener(this.materialEditor.Repaint);
            helpAnimation.speed = 4f;
        ...
        private void DrawHeader()
        {
            ...
            using(new EditorGUILayout.HorizontalScope())
            {
                ...
                helpExpanded = GUILayout.Toggle(helpExpanded, new GUIContent("Toggle help  ", EditorGUIUtility.IconContent("_Help").image, "Show help"), EditorStyles.miniButtonMid);
                helpAnimation.target = helpExpanded;
            }
            GUILayout.Space(1f);

            if (EditorGUILayout.BeginFadeGroup(helpAnimation.faded))
            {
                using (new EditorGUILayout.HorizontalScope())
                {
                ...
                UI.DrawNotification("If you have any questions, or ran into issues, please consult the documentation first.", MessageType.Info);
